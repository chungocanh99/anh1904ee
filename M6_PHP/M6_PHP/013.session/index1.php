...
<pre>
    ...
    ví dụ:
    khi tạo ra 1 session đăng nhập session này sẽ làm việc trên trang chủ(home.php), trang tin tức(new.php), trang danh mục(category.php)...
    session thường được sử dụng để lưu trữ thông tin đăng nhập, data giỏ hàng của khách hàng trên các trang mua sắm
