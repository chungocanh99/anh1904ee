        ...
        <div class="col-md-12">
            ...
            <form name="create" action ="" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="radio" name="status" class="form-control" value="<?php echo $status?>">Unpublish
                    <input type="radio" name="status" class="form-control" value="<?php echo $status?>">Publish
